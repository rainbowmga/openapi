    ...
    "paths": {
        ...
        "/indication": {
            "post": {
                ...
                "description": "Use the endpoint to create an Indication. *Note* the url provided in the quote will enables the agent to log in without a sign in step to the rainbow platform. As a result, to keep these links secure, it will expire within a few days. If you need a refreshed url please use the \"Query by Indication ID\" endpoint to query the indication again this will provide a new url with a refreshed expiration date.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/indication/id/{IndicationID}": {
            "get": {
                ...
                "description": "Use the endpoint to fetch the created quote indication based on an Indication ID. This endpoint will also give you a refreshed quote url so you may use it to get a new url if your previous has expired.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        ...
        "model.CreateQuoteIndicationRequest": {
            ...
            "properties": {
                ...
                "policy_effective_date": {
                    "description": "The effective date for the policy, must be in RFC3339 format or YYYY-MM-DD.",
                    "type": "string"
                },
                "product_code": {
                    "description": "Code representing the insurance product linked to the queried appetite.",
        ...
        "model.URLInfo": {
            ...
            "properties": {
                "expires_at": {
                    "description": "the time at which this url will expire. Please refetch the quote indication if this has expired.",
                    "type": "string"
                },
                "url": {
                    "description": "The pre-authed URL into the rainbow dashboard for your agent to complete the quote with.",
                    "type": "string"
                }
            }
        },
        ...
        "monolith_endpoint_partner_model.Quote": {
            ...
            "properties": {
                "application_url": {
                    "description": "The URL to complete the application. *Note* this will expire please refetch the data if it expires.",
                    "allOf": [
                        {
